      ...
      <FlatList
             ...
             renderItem={({item}) => (
                ...
                <View style={{
                 ...
                 <View>
                 {/* <Text style={styles.headerTextNormal}>{item.title}</Text></View>
                 <View>
                 <Text style={styles.headerTextNormal}>{item.description}</Text></View>
                 <View> */}
                 <Text style={styles.headerTextNormal}>{item.date}일{item.description} 명 테이블 예약</Text></View>
                 <View>
              <Text>승인</Text>
              </View>
              <View >
